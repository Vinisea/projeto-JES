      ...
      <section className="admin-panels">
        <article className="admin-panel">
          ...
          <div className="admin-match">
            <span className="match-time">09:00</span>
            <div>
              <strong>
                9º B <small>vs</small> 9º A
              </strong>
              <small>Voleibol Masculino • Quadra 1</small>
            </div>
            <span className="match-badge">Hoje</span>
          </div>
          <div className="admin-match">
            <span className="match-time">10:30</span>
            <div>
              <strong>
                2º EM A <small>vs</small> 1º EM B
              </strong>
              <small>Fut7 Masculino • Campo 1</small>
            </div>
            <span className="match-badge">Hoje</span>
          </div>
        </article>
