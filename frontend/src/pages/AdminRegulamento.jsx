    ...
    >
      <section className="admin-panel full-panel">
        ...
        <p className="regulation-text">
          Os Jogos Internos SESI têm como objetivo promover integração,
          respeito, participação e espírito esportivo entre os estudantes.
        </p>
        <button className="panel-button">Editar regulamento</button>
      </section>
    </AdminLayout>
  );
}
